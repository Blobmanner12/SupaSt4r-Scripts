--[[
    ...
    Version: 2.5 (GUI Construction Fix)

    - FIXED: A critical GUI creation error that prevented the "Universal Aimbot"
             panel and its key box from appearing.
    - RE-ARCHITECTED: The GUI construction logic is now more robust and explicit
...
local function initialize_loader()
    ...
    --// --- GUI Creation (Rebuilt for Stability) ---
    
    -- 1. Create Parent Containers
    ...
    -- 2. Create Title and Status Labels
    ...
    local statusLabel = Instance.new("TextLabel", mainFrame); statusLabel.Size = UDim2.new(1, -20, 0, 20); statusLabel.Position = UDim2.new(0, 10, 1, -25); statusLabel.Font = Enum.Font.SourceSans; statusLabel.TextColor3 = Color3.fromRGB(255, 200, 0); statusLabel.Text = GameInfo and "Game detected. Ready to load." or "Game not supported by hub."; statusLabel.TextXAlignment = Enum.TextXAlignment.Left; statusLabel.TextSize = 14

    -- 3. Create Left Panel (Game-Specific Hub)
    local gameHubFrame = Instance.new("Frame", mainFrame); gameHubFrame.Size = UDim2.new(0.5, -15, 1, -75); gameHubFrame.Position = UDim2.new(0, 10, 0, 35); gameHubFrame.BackgroundColor3 = Color3.fromRGB(45,45,45);
    ...
    -- 4. Create Right Panel (Universal Aimbot)
    local aimbotFrame = Instance.new("Frame", mainFrame); aimbotFrame.Size = UDim2.new(0.5, -15, 1, -75); aimbotFrame.Position = UDim2.new(0.5, 5, 0, 35); aimbotFrame.BackgroundColor3 = Color3.fromRGB(45,45,45);
